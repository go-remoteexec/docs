...
The layer both orchestrators run commands through: local, SSH and WinRM connections with sudo, su and doas escalation.
...
- **[Modules](modules.md)** — every module in go-remoteexec, with its source and its reference.
